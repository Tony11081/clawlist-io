        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div>
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
              Autonomous agent coverage, OpenClaw workflows, and reviewed
              skills.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <CookiePreferencesButton className="text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100" />
              </li>
            </ul>
          </div>
        </div>
